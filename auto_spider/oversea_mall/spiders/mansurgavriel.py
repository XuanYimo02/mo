...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'mansurgavriel:goods_all_list'
    platform = "mansurgavriel"
    task_id = 'mansurgavriel'
    sch_task = 'mansurgavriel-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        page = 1
        urls = [
            'https://www.mansurgavriel.com/collections/bags?page=1',
            'https://www.mansurgavriel.com/collections/new-arrivals?page=1',
            'https://www.mansurgavriel.com/collections/shoes?page=1',
            'https://www.mansurgavriel.com/collections/small-leather-goods?page=1',
            'https://www.mansurgavriel.com/collections/sale-view-all?page=1'
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        div_list = response.xpath('//*[@id="collectionProductItems"]/div')
        for div in div_list:
            url = 'https://www.mansurgavriel.com' + div.xpath('./a/@href').extract()[0]
            yield scrapy.Request(
                url=url,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl mansurgavriel:goods_all_list'.split(' '))
