...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'patmcgrath:goods_all_list'
    platform = "patmcgrath"
    task_id = 'patmcgrath'
    sch_task = 'patmcgrath-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        """
        urls = [
            'https://www.patmcgrath.com/collections/lips',
            'https://www.patmcgrath.com/collections/new',
            'https://www.patmcgrath.com/collections/eyes',
            'https://www.patmcgrath.com/collections/face',
            'https://www.patmcgrath.com/collections/divine-skin-rose-001-the-collection',
            'https://www.patmcgrath.com/collections/kits',
            'https://www.patmcgrath.com/collections/direct-from-pat-s-vault',
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        for div in div_list:
            try:
                url = 'https://www.patmcgrath.com' + div.xpath('./div/div[2]/a/@href').extract()[0]
                yield scrapy.Request(
                    url=url,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl patmcgrath:goods_all_list'.split(' '))
