...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'corridornyc:goods_all_list'
    platform = "corridornyc"
    task_id = 'corridornyc'
    sch_task = 'corridornyc-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        """
        urls = [
            'https://corridornyc.com/collections/shop-all',
            'https://corridornyc.com/collections/new-arrivals',
            'https://corridornyc.com/collections/summer-collection',
            'https://corridornyc.com/collections/handmade',
            'https://corridornyc.com/collections/corridor-x-sample-eyewear',
            'https://corridornyc.com/collections/core',
            'https://corridornyc.com/collections/book-shelf',
            'https://corridornyc.com/collections/home',
            'https://corridornyc.com/collections/shirts',
            'https://corridornyc.com/collections/t-shirt',
            'https://corridornyc.com/collections/knitwear',
            'https://corridornyc.com/collections/bottoms-1',
            'https://corridornyc.com/collections/shorts',
            'https://corridornyc.com/collections/denim',
            'https://corridornyc.com/collections/outerwear',
            'https://corridornyc.com/collections/accessories',
            'https://corridornyc.com/collections/suits',
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        爬虫首页抓取
        """
        div_list = response.xpath('//*[@class="main"]/div/div[1]/div[2]/div')
        for div in div_list:
            url = 'https://corridornyc.com' + div.xpath('./div[1]/a/@href').extract()[0]
            yield scrapy.Request(
                url=url,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl corridornyc:goods_all_list'.split(' '))
