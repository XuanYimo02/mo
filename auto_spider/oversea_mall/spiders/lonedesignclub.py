...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'lonedesignclub:goods_all_list'
    platform = "lonedesignclub"
    task_id = 'lonedesignclub'
    sch_task = 'lonedesignclub-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        page = 1
        urls = [
            'https://lonedesignclub.com/collections/shop-all-womens?page=1',
            'https://lonedesignclub.com/collections/mens?page=1',
            'https://lonedesignclub.com/collections/under-100?page=1',
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        div_list = response.xpath('//*[@id="CollectionAjaxContent"]/div/div/div[3]/div[2]/div/div[1]/div[2]/div')
        for div in div_list:
            url = 'https://lonedesignclub.com' + div.xpath('./div[1]/a/@href').extract()[0]
            yield scrapy.Request(
                url=url,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl lonedesignclub:goods_all_list'.split(' '))
