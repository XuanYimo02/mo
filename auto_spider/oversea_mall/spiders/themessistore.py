...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'themessistore:goods_all_list'
    platform = "themessistore"
    task_id = 'themessistore'
    sch_task = 'themessistore-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        """
        page = 1
        url = 'https://www.themessistore.com/collections/all?page=1'
    ...
    async def parse_home(self, response, **kwargs):
        ...
        div_list = response.xpath('//*[@id="CollectionAjaxContent"]/div[1]/div/div[2]/div/div[3]/div')
        for div in div_list:
            url = 'https://www.themessistore.com' + div.xpath('./div/a/@href').extract()[0]
            yield scrapy.Request(
                url=url,
    ...
    async def parse_detail(self, response, **kwargs):
        ...
        爬虫详情页抓取
        """
        pattern = r'_BISConfig.product = (.*?);      _BISConfig.product.variants'
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl themessistore:goods_all_list'.split(' '))
