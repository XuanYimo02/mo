...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'heist-studios:goods_all_list'
    platform = "heist-studios"
    task_id = 'heist-studios'
    sch_task = 'heist-studios-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        page = 1
        urls = [
            'https://www.heist-studios.com/collections/new',
            'https://www.heist-studios.com/collections/best-selling-products',
            'https://www.heist-studios.com/collections/tights',
            'https://www.heist-studios.com/collections/shapewear',
            'https://www.heist-studios.com/collections/underwear-clothing',
            'https://www.heist-studios.com/collections/sale',
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        div_list = response.xpath('//*[@id="content"]/div/div/div/div[2]/div[2]/div[2]/div/div')
        for div in div_list:
            try:
                url = 'https://www.heist-studios.com' + div.xpath('./div[1]/div/div[1]/a[1]/@href').extract()[0]
                yield scrapy.Request(
                    url=url,
    ...
    async def parse_detail(self, response, **kwargs):
        ...
        if json_data["compare_at_price"] == None or json_data["compare_at_price"] == 0:
            ori_price = cur_price
        else:
        ...
        for variant in variants:
            ...
            if variant["compare_at_price"] == None or variant["compare_at_price"] == 0:
                origPrice = price
            else:
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl heist-studios:goods_all_list'.split(' '))
