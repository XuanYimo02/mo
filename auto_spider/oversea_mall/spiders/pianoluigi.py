...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'pianoluigi:goods_all_list'
    platform = "pianoluigi"
    task_id = 'pianoluigi'
    sch_task = 'pianoluigi-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        """
        urls = [
            'https://pianoluigi.com/collections/mens?page=1',
            'https://pianoluigi.com/collections/womens?page=1',
            'https://pianoluigi.com/collections/all?page=1',
            'https://pianoluigi.com/collections/sneakers?page=1',
            'https://pianoluigi.com/collections/watches?page=1',
            'https://pianoluigi.com/collections/sale?page=1',
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        div_list = response.xpath('/html/body/div[5]/main/div[1]/section/div[3]/div[2]/div[2]/div[1]/div/div')
        for div in div_list:
            try:
                url = 'https://pianoluigi.com' + div.xpath('./div/div/a/@href').extract()[0]
                yield scrapy.Request(
                    url=url,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl pianoluigi:goods_all_list'.split(' '))
