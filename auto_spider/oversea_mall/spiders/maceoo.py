...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'maceoo:goods_all_list'
    platform = "maceoo"
    task_id = 'maceoo'
    sch_task = 'maceoo-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        page = 1
        urls = [
            'https://maceoo.com/collections/shop-dress-shirts?page=1',
            'https://maceoo.com/collections/shop-stretch-dress-shirts?page=1',
            'https://maceoo.com/collections/shop-polos?page=1',
            'https://maceoo.com/collections/shop-v-necks?page=1',
            'https://maceoo.com/collections/shop-sweaters-hoodies?page=1',
            'https://maceoo.com/collections/shop-hats?page=1',
            'https://maceoo.com/collections/shop-tees?page=1',
            'https://maceoo.com/collections/designer-fashion-mens-blazers?page=1',
            'https://maceoo.com/collections/shop-leather-jackets?page=1',
            'https://maceoo.com/collections/shop-stretch-jeans?page=1',
            'https://maceoo.com/collections/shop-stretch-pants?page=1',
            'https://maceoo.com/collections/shop-shoes?page=1',
            'https://maceoo.com/collections/shop-swim?page=1',
            'https://maceoo.com/collections/shop-joggers?page=1',
            'https://maceoo.com/collections/shop-shorts?page=1',
            'https://maceoo.com/collections/collection-best-sellers?page=1',
            'https://maceoo.com/collections/collection-athleisure-sets?page=1',
            'https://maceoo.com/collections/shop-athleisure?page=1',
            'https://maceoo.com/collections/collection-skulls?page=1',
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        div_list = response.xpath('//*[@id="shopify-section-collection-template"]/section/div[3]/div[2]/div[2]/div[1]/div/div')
        for div in div_list:
            url = 'https://maceoo.com' + div.xpath('./div/div/a/@href').extract()[0]
            yield scrapy.Request(
                url=url,
    ...
    async def parse_detail(self, response, **kwargs):
        ...
        breadlist = json_data["product"]["type"]
        cur_price = float(str(json_data["product"]["price"])[:-2] + '.' + str(json_data["product"]["price"])[-2:])
        if json_data["product"]["compare_at_price"] == None:
            ori_price = cur_price
        else:
            ori_price = float(str(json_data["product"]["compare_at_price"])[:-2] + '.' + str(json_data["product"]["compare_at_price"])[-2:])
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl maceoo:goods_all_list'.split(' '))
