...
class GoodsAllListSpider(DmSpider, AutoParse):
    ...
    headers = {
        ...
        "origin": "https://www.venum.com",
        "priority": "u=1, i",
        "referer": "https://www.venum.com/",
    ...
    def start_requests(self):
        ...
        """
        urls = [
            'https://www.venum.com/collections/mens-t-shirts',
            'https://www.venum.com/collections/shorts-men',
            'https://www.venum.com/collections/boxing-shoes',
            'https://www.venum.com/collections/accessories',
            'https://www.venum.com/collections/sweatshirts-jackets-men',
            'https://www.venum.com/collections/pants-men',
            'https://www.venum.com/collections/sports-gym-duffle-bags',
            'https://www.venum.com/collections/womenss-tops-t-shirts',
            'https://www.venum.com/collections/shorts-for-women',
            'https://www.venum.com/collections/womens-shoes',
            'https://www.venum.com/collections/bag-and-accessories',
            'https://www.venum.com/collections/sweatshirts-jackets-women',
            'https://www.venum.com/collections/pants-women',
            'https://www.venum.com/collections/tote-bag-backpack-and-sports-bag',
            'https://www.venum.com/collections/kids-clothing',
            'https://www.venum.com/collections/kids-equipment',
            'https://www.venum.com/collections/kids-outlet-1',
            'https://www.venum.com/collections/protective-equipment',
            'https://www.venum.com/collections/mma',
            'https://www.venum.com/collections/muay-thai-1',
            'https://www.venum.com/collections/punching-bags',
            'https://www.venum.com/collections/bjj',
            'https://www.venum.com/collections/fitness-category',
            'https://www.venum.com/collections/starter-packs',
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        """
        meta = response.meta
        store_id = response.xpath('//*[@id="in-context-paypal-metadata"]/@data-shop-id').extract()[0]
        category_id = response.xpath('/html/head/meta[11]/@content').extract()[0].split('page_id=')[-1].split(', site_id')[0]
        page = 1
        ...
        params = {
            ...
            "src": "v-next",
            "UUID": "8c926b80-91c6-4d5e-b7b7-715a07ae6398",
            "uuid": "8c926b80-91c6-4d5e-b7b7-715a07ae6398",
            "store_id": store_id,
            "api_type": "json",
        ...
        url = "https://api.fastsimon.com/categories_navigation?" + urlencode(params)
        yield scrapy.Request(
            url=url,
            headers=self.headers,
    ...
    async def parse_list(self, response, **kwargs):
        ...
        for item in item_list:
            url = 'https://www.venum.com' + item["u"]
            yield scrapy.Request(
                url=url,
                headers=self.headers,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl venum:goods_all_list'.split(' '))
