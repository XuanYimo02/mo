...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'shoppremiumoutlets:goods_all_list'
    platform = "shoppremiumoutlets"
    task_id = 'shoppremiumoutlets'
    sch_task = 'shoppremiumoutlets-task'
    today = datetime.now()
    ...
    base_url = "https://shoppremiumoutlets.com"
    UUID = ""
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl shoppremiumoutlets:goods_all_list'.split(' '))
