...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'hauteflair:goods_all_list'
    platform = "hauteflair"
    task_id = 'hauteflair'
    sch_task = 'hauteflair-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        page = 1
        urls = [
            'https://hauteflair.com/collections/bras?page=1',
            'https://hauteflair.com/collections/panties?page=1',
            'https://hauteflair.com/collections/sexy-sleepwear?page=1',
            'https://hauteflair.com/collections/swimwear?page=1',
            'https://hauteflair.com/collections/shapewear?page=1',
        ]
        for url in urls:
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl hauteflair:goods_all_list'.split(' '))
