...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'hourglasscosmetics:goods_all_list'
    platform = "hourglasscosmetics"
    task_id = 'hourglasscosmetics'
    sch_task = 'hourglasscosmetics-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        """
        urls = [
            'https://www.hourglasscosmetics.com/collections/bestsellers?page=1',
            'https://www.hourglasscosmetics.com/collections/makeup?page=1',
            'https://www.hourglasscosmetics.com/collections/gifts-sets?page=1',
            'https://www.hourglasscosmetics.com/collections/new?page=1',
            'https://www.hourglasscosmetics.com/collections/skincare?page=1',
            'https://www.hourglasscosmetics.com/collections/brushes?page=1',
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        div_list = response.xpath('//*[@id="Collection"]/div[5]/div[1]/div')
        for div in div_list:
            try:
                url = 'https://www.hourglasscosmetics.com' + div.xpath('./div/a/@href').extract()[0]
                yield scrapy.Request(
                    url=url,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl hourglasscosmetics:goods_all_list'.split(' '))
