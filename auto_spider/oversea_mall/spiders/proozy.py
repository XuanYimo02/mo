...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'proozy:goods_all_list'
    platform = "proozy"
    task_id = 'proozy'
    sch_task = 'proozy-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        """
        urls = [
            'https://www.proozy.com/collections/womens-shoes?page=1',
            'https://www.proozy.com/collections/womens-accessories?page=1',
            'https://www.proozy.com/collections/womens-clearance?page=1',
            'https://www.proozy.com/collections/mens-clearance?page=1',
            'https://www.proozy.com/collections/mens-shoes?page=1',
            'https://www.proozy.com/collections/mens-accessories?page=1',
            'https://www.proozy.com/collections/boys-1?page=1',
            'https://www.proozy.com/collections/all-girls-clearance?page=1',
            'https://www.proozy.com/collections/youth-shoes?page=1',
            'https://www.proozy.com/collections/home?page=1',
            'https://www.proozy.com/collections/clearance?page=1'
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        for li in li_list:
            try:
                url = 'https://www.proozy.com' + li.xpath('./div/div[2]/h3/a/@href').extract()[0]
                yield scrapy.Request(
                    url=url,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl proozy:goods_all_list'.split(' '))
