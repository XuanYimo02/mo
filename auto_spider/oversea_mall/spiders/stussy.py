...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'stussy:goods_all_list'
    platform = "stussy"
    task_id = 'stussy'
    sch_task = 'stussy-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        爬虫首页
        """
        url = 'https://www.stussy.com/collections/all?page=1'
    ...
    async def parse_home(self, response, **kwargs):
        ...
        li_list = response.xpath(
            '//*[@id="MainContent"]/section/s-collection-grid/div[2]/ul/li')
        for li in li_list:
            try:
                url = 'https://www.stussy.com' + li.xpath('./div/a/@href').extract()[0]
                yield scrapy.Request(
                    url=url,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl stussy:goods_all_list'.split(' '))
