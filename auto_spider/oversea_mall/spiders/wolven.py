...
class GoodsAllListSpider(DmSpider, AutoParse):
    name = 'wolven:goods_all_list'
    platform = "wolven"
    task_id = 'wolven'
    sch_task = 'wolven-task'
    today = datetime.now()
    ...
    def start_requests(self):
        ...
        page = 1
        urls = [
            'https://wolventhreads.com/collections/all-womens?page=1',
            'https://wolventhreads.com/collections/basics?page=1',
            'https://wolventhreads.com/collections/prints?page=1',
            'https://wolventhreads.com/collections/mens?page=1',
            'https://wolventhreads.com/collections/festival-shop?page=1',
        ]
        for url in urls:
    ...
    async def parse_home(self, response, **kwargs):
        ...
        div_list = response.xpath('//*[@id="content"]/div/div[3]/div/div[2]/div[2]/div[2]/div/div')
        for div in div_list:
            try:
                url = 'https://wolventhreads.com' + div.xpath('./div/div/div[1]/a[1]/@href').extract()[0]
                yield scrapy.Request(
                    url=url,
...
if __name__ == '__main__':
    ...
    execute('scrapy crawl wolven:goods_all_list'.split(' '))
